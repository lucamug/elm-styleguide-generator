...
var _lucamug$elm_styleguide_generator$Styleguide$update = F2(
	function (msg, model) {
		var _p8 = msg;
		var toggle = function (_p9) {
			var _p10 = _p9;
			var _p12 = _p10._1;
			var _p11 = _p10._0;
			return _elm_lang$core$Native_Utils.eq(_p11.name, _p8._0) ? {ctor: '_Tuple2', _0: _p11, _1: !_p12} : {ctor: '_Tuple2', _0: _p11, _1: _p12};
		};
							...
							A2(
								...
								open ? {
									...
									_0: _mdgriffith$stylish_elephants$Element$htmlAttribute(
										_elm_lang$html$Html_Attributes$class('xxxopen')),
									_1: {ctor: '[]'}
								} : {
									ctor: '::',
									_0: _mdgriffith$stylish_elephants$Element$htmlAttribute(
										_elm_lang$html$Html_Attributes$class('xxxclose')),
									_1: {ctor: '[]'}
								}),
							menuStyle ? {
								ctor: '::',
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				function (_p13) {
					var _p14 = _p13;
					return A3(_lucamug$elm_styleguide_generator$Styleguide$viewSection, _p14._0, _p14._1, true);
				},
				model),
			{
				ctor: '::',
			...
			_0: A2(
				...
				A2(
					...
					A2(
						...
						function (_p15) {
							var _p16 = _p15;
							return A3(_lucamug$elm_styleguide_generator$Styleguide$viewSection, _p16._0, _p16._1, true);
						},
						model))),
			_1: {ctor: '[]'}
		});
